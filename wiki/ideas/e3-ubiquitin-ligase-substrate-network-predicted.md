...
status: validated
origin: "Migrated from claims/e3-ubiquitin-ligase-substrate-network-predicted on 2026-05-10 (was status: supported, confidence: 0.75); see Pilot results for original paper-level evidence."
origin_gaps: []
...
**Scope and conditions.** - Performance is measured on human ESIs only; transfer to other species (or other ligation cascades like SUMOylation, NEDDylation) is not established by the cited evidence.
